      ...
      '<div class="container">' +
        '<div class="footer__grid">' +
          ...
          '<div class="footer__col">' +
            ...
            '<p class="footer__line">사무실 주차는 어려우며, 인근 롯데골드로즈2차 오피스텔 지하주차장을 유료로 이용할 수 있습니다.</p>' +
    ...
    '<div class="modal" id="termsModal" hidden>' +
      ...
      '<div class="modal__dialog" role="dialog" aria-modal="true" aria-labelledby="termsModalTitle" tabindex="-1">' +
        ...
        '<div class="modal__body legal">' +
          ...
          '<h3>제5조 (책임의 제한)</h3><p>홈페이지에 게시된 정보는 일반적인 세무정보 제공을 목적으로 합니다. 구체적인 세법 적용 결과는 사실관계와 적용 시점의 법령·예규·판례에 따라 달라질 수 있습니다. 이용자는 중요한 세무 의사결정 전에 별도의 전문적인 검토를 받아야 합니다.</p>' +
