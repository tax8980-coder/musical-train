    ...
    '<div class="modal" id="privacyModal" hidden>' +
      ...
      '<div class="modal__dialog" role="dialog" aria-modal="true" aria-labelledby="privacyModalTitle" tabindex="-1">' +
        ...
        '<div class="modal__body legal">' +
          ...
          '<ul><li>수탁자: Google LLC(구글) / 위탁 업무: 온라인 상담 신청서 접수 및 응답 저장(Google Forms·Google Sheets) / 보유기간: 위탁계약 종료 또는 상담 목적 달성 시까지</li><li>수탁자: [수탁업체명 입력] / 위탁 업무: [예: 홈페이지 운영·서버 호스팅] / 보유기간: [입력]</li><li>수탁자: [수탁업체명 입력] / 위탁 업무: [예: 세무회계 프로그램 운영] / 보유기간: [입력]</li></ul>' +
